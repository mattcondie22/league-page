...
/*   STEP 2   */
export const homepageText = `In 2016, a group of young boys embarked on a journey that would forever change the course of their lives. This journey would be full of arguments,
...
export const managers = [
    ...
    },
    {
      ...
      "rival": {
        name: "Triston", // Can be anything (usually your rival's name)
        link: null, // manager array number within this array, or null to link back to all managers page
      ...
      "bio": "Bio: Tristen has to work every Sunday but that doesn't stop him from getting lit af and crushing his opponents every week in fantasy. First b2b league winner, bringing home a 3rd ship this year after an unlucky year on the 3Peat.",
      ...
      "bio": "Bio: Deadly trade specialist, degenerate gambler, Sky Bri supporter.",
      "photo": "/managers/sal.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2016, // (optional) when did the manager start playing fantasy football
      ...
      "rival": {
        ...
        link: null, // manager array number within this array, or null to link back to all managers page
        image: "/managers/ray.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      ...
      "favoriteTeam": "ari", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "rival": {
        name: "Adriaan", // Can be anything (usually your rival's name)
        link: null, // manager array number within this array, or null to link back to all managers page
        image: "/managers/adriaan.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      ...
      "bio": "Bio: Trey has an innate ability to draft elite talent every year. His addiction to trading has proven to be the bane of his existence.",
      ...
      "rival": {
        name: "Tristen", // Can be anything (usually your rival's name)
        link: null, // manager array number within this array, or null to link back to all managers page
        image: "/managers/tristen.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      "favoritePlayer": 8676, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "philosophy": "Top Secret Information",
      "tradingScale": 8, // 1 - 10
      "preferredContact": "Sleeper", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
  ]
